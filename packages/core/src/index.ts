...
export {
  ...
  buildMemoryDiffPrompt,
  parseMemoryDiffResponse,
} from './analysis/memory-diff.js';
...
export {
  evaluateAndCorrect,
  shouldTriggerAutocorrect,
  planCorrections,
  executeCorrection,
  buildCorrectionHint,
  getDefaultAutocorrectConfig,
} from './analysis/autocorrect.js';
export type {
  AutocorrectConfig,
  AutocorrectContext,
  CorrectionRecord,
